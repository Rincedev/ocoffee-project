function loadRecaptchaScript() {
  return new Promise((resolve, reject) => {
    ...
    script.src = 'https://www.google.com/recaptcha/api.js?render=6Ld0_NYqAAAAACzmWzW2J_dGeWfaxMExl8dJJ9KM';
...
loadRecaptchaScript().then(() => {
  ...
  console.error('Erreur lors du chargement de l\'API reCAPTCHA :', error);
});
